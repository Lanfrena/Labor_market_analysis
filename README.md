###Мониторинг рынка труда («Вектор Фарм»)
...
2. Стек технологий
  ...
  - DAX: Реализация продвинутых мер для расчета накопительных итогов, процентов прироста год к году (YoY), динамического ранжирования (Топ-5 с общим итогом), вычисления средних значений и условной фильтрации через USERELATIONSHIP.
...
d) Когортный и отраслевой анализ:
